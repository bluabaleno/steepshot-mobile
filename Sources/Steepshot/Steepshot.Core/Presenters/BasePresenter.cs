...
namespace Steepshot.Core.Presenters
{
    public abstract class BasePresenter
    {
        ...
        public static string ToFormatedCurrencyString(double value, string postfix = null)
        {
            return $"{Currency} {value.ToString("F", CultureInfo)}{(string.IsNullOrEmpty(postfix) ? string.Empty : " ")}{postfix}";
        }
